# Gemini Raw Observation Prompt

Use this only when the user explicitly requests Gemini/AI Studio raw intake.
The result is an unverified second-by-second observation record for Codex source
analysis, not a final script or source-of-truth record.
