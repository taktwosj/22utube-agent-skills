...
This file is also the sole Shorts review contract attached to the ChatGPT
project `쇼츠대본분석`. Do not add a second Shorts contract to that project.
...
`shorts_script_analysis_single_source_v20260706.md`, as the sole Shorts source
contract and rerun the packet. Do not attach an archived or second Shorts
contract.
