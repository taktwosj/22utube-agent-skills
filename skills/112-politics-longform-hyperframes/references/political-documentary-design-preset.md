...
```text
PROFILE_ID=politics_documentary_broadcast_v1
...
- 좌측 챕터 내비게이션은 약 22%, 중앙 콘텐츠는 약 72%를 사용한다.
...
- 비교 장면은 사건 카드에서 선택 카드로 이어지는 단순한 수평 흐름으로 만든다.
- 선택 항목만 노란 포인트 바 또는 1px 테두리로 강조한다.
