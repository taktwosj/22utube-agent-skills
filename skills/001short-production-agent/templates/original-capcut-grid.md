...
| 레이어 / source 시간 | <00:00.000–00:02.000> | <00:02.000–00:05.000> |
|---|---|---|
...
규칙: 실제 산출물에서는 꺾쇠 placeholder를 제거하고 각 시간 헤더를 실측 `start–end`로 바꾼다. bare `없음`, `비움`, `UNVERIFIED`만 쓰지 않는다. 실제 부재에는 source 근거를, 미확정에는 재확인할 evidence를 함께 쓴다.
