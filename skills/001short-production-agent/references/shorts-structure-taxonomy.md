...
| 단계 | 확정할 것 | 금지 |
|---|---|---|
| 가(가이드라인) | 시청자가 끝에 이해할 한 문장, 타깃 감정, 금지선, 훅의 미해결 질문 | 원본 요약을 목표로 삼기 |
| 단(단어) | 제목·상황 자막·대사의 핵심 단어를 새 정보 순서에 맞춰 재맥락화 | 원본 자막의 단순 동의어 치환 |
| 야(야부리) | 훅, 인과 브리지, 대사 진입, 회수에 필요한 짧은 연결 TTS | 모든 장면에 TTS를 덮어 원본 행동/대사를 지우기 |
